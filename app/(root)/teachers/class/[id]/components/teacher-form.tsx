...
export const TeacherForm: React.FC<TeacherFormProps> = ({
  ...
  const form = useForm<TeacherFormValues>({
    ...
    defaultValues: {
      classId: initialData ? initialData.classId : "",
      teacherId: initialData ? initialData.teacherId : "",
    },
  });
  ...
  const onSubmit = async (data: TeacherFormValues) => {
    try {
      ...
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/teachers/class/${params.id}`, data);
      } else {
        await axios.post(`/api/teachers/class`, data);
      }
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/teachers/class/${params.id}`);
      router.refresh();
      router.push(`/teachers`);
